...
> test plans, and migration & rollout sections.
>
> For navigation, start at [`research/00-INDEX.md`](research/00-INDEX.md).
> For shared terminology used across modules, see
> [`research/GLOSSARY.md`](research/GLOSSARY.md).
> For the BE-first implementation reference (real
> Express+TypeORM code, one section per P0/P1 gap), see
> [`be-implementation/DBEXEC-BE-IMPLEMENTATION.md`](be-implementation/DBEXEC-BE-IMPLEMENTATION.md).
> For the multi-tab dashboard companion, see
