...
| **Stacked bar-column** | 2D × 1M (or 1D × ≥2M) | Show composition *and* total per category; segments stack to the total | `[table-stakes]` |
| **100% stacked bar-column** | 2D × 1M | Compare *proportional* composition across categories (each bar = 100%); use when relative share matters more than absolute | `[table-stakes]` |
...
| **Stacked bar as part-to-whole** | 1D × 1M | A single 100% stacked bar is often the *recommended replacement* for a pie | `[table-stakes]` |
...
| **Bump chart** | 1D × M over T (ranks) | Rank *position* changes over time (e.g. leaderboard across seasons) | `[advanced]` |
