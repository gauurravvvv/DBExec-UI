...
The research modules say _what to build_. The implementation
docs say _exactly how_ — controller code, migrations, FE
...
exports"), follow the _feature-slice_ companions in the previous
