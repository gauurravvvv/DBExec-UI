...
@Component({
  selector: 'app-bulk-add-system-user',
  templateUrl: './bulk-add-system-user.component.html',
  styleUrls: ['./bulk-add-system-user.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class BulkAddSystemUserComponent implements OnInit {
  ...
  ngOnInit(): void {
    // A System user always carries the default org id in their token, so
    // this gate passes and enables the CSV dropzone. Kept as-is (matches
    // the source) to minimise churn — the bulk validate/commit calls take
    // no org param.
    this.selectedOrgId =
