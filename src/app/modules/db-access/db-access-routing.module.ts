...
// The LISTING landing lives at '' — a datasource dropdown in the toolbar
// (like list-dataset / list-tab) loads that datasource's data inline and
// reflects the selection in the URL (/:datasourceId). Static segments
// (users/new, roles/new) come BEFORE the :roleName capture so the router
// doesn't grab the word "new" as a role name.
const routes: Routes = [
  { path: '', component: DbAccessWorkspaceComponent },
  {
