...
export const QUERY_RUNNER = {
  ...
  SAVED_QUERIES_LIST: '/app/sql',
  savedQueryNew: () => '/app/sql/saved-queries/new',
  savedQueryView: (id: string) => `/app/sql/saved-queries/${id}`,
  savedQueryEdit: (id: string) => `/app/sql/saved-queries/${id}/edit`,
