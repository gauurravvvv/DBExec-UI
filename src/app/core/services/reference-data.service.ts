...
export class ReferenceDataService {
  ...
  private static readonly FALLBACK: ReferenceDataMap = {
    ...
    filter_operator: [
      { code: 'EQUALS', label: 'Equals', meta: { filterType: 'category' }, sequence: 1 },
      { code: 'DOES_NOT_EQUAL', label: 'Does not equal', meta: { filterType: 'category' }, sequence: 2 },
      { code: 'CONTAINS', label: 'Contains', meta: { filterType: 'category' }, sequence: 3 },
      { code: 'DOES_NOT_CONTAIN', label: 'Does not contain', meta: { filterType: 'category' }, sequence: 4 },
      { code: 'STARTS_WITH', label: 'Starts with', meta: { filterType: 'category' }, sequence: 5 },
      { code: 'ENDS_WITH', label: 'Ends with', meta: { filterType: 'category' }, sequence: 6 },
      { code: 'EQUALS', label: 'Equals', meta: { filterType: 'numeric_equality' }, sequence: 7 },
      { code: 'NOT_EQUALS', label: 'Not equals', meta: { filterType: 'numeric_equality' }, sequence: 8 },
      { code: 'GREATER_THAN', label: 'Greater than', meta: { filterType: 'numeric_equality' }, sequence: 9 },
      { code: 'GREATER_THAN_OR_EQUAL', label: 'Greater than or equal', meta: { filterType: 'numeric_equality' }, sequence: 10 },
      { code: 'LESS_THAN', label: 'Less than', meta: { filterType: 'numeric_equality' }, sequence: 11 },
      { code: 'LESS_THAN_OR_EQUAL', label: 'Less than or equal', meta: { filterType: 'numeric_equality' }, sequence: 12 },
      { code: 'BETWEEN', label: 'Between', meta: { filterType: 'numeric_range' }, sequence: 13 },
      { code: 'EQUALS', label: 'Equals', meta: { filterType: 'time_equality' }, sequence: 14 },
      { code: 'BEFORE', label: 'Before', meta: { filterType: 'time_equality' }, sequence: 15 },
      { code: 'AFTER', label: 'After', meta: { filterType: 'time_equality' }, sequence: 16 },
      { code: 'BETWEEN', label: 'Between', meta: { filterType: 'time_range' }, sequence: 17 },
    ],
  };
