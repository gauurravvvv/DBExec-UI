...
export class ConfigurablePolarBarChartComponent implements OnInit, OnChanges, DoCheck {
  ...
  private defaultConfig: any = { animations: true, tooltipDisabled: false, colorScheme: 'vivid', showDataLabel: false, yAxis: true, roundEdges: false, legend: false, legendPosition: 'right', toolbox: false };
