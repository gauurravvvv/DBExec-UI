...
export class ConfigurableScatterGlChartComponent implements OnInit, OnChanges, DoCheck {
  ...
  @Input() chartType: string = 'scattergl';
  ...
  updateChartOption(): void {
    this.chartOption = buildScatterGLChartOption(this.data, this.config);
  }
