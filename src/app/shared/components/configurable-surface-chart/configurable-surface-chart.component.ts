...
export class ConfigurableSurfaceChartComponent implements OnInit, OnChanges, DoCheck {
  ...
  @Input() chartType: string = 'surface';
  ...
  updateChartOption(): void {
    this.chartOption = buildSurfaceChartOption(this.data, this.config);
  }
