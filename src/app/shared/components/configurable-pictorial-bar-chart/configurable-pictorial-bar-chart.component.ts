...
export class ConfigurablePictorialBarChartComponent implements OnInit, OnChanges, DoCheck {
  ...
  private defaultConfig: any = { animations: true, tooltipDisabled: false, colorScheme: 'vivid', showDataLabel: false, xAxis: true, yAxis: true, showGridLines: true, showXAxisLabel: true, showYAxisLabel: true, xAxisLabel: 'Category', yAxisLabel: 'Value', pictorialSymbol: 'roundRect', pictorialRepeat: false, toolbox: false };
