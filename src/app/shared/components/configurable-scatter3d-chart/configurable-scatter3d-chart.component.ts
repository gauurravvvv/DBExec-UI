...
export class ConfigurableScatter3dChartComponent implements OnInit, OnChanges, DoCheck {
  ...
  @Input() chartType: string = 'scatter3d';
  ...
  updateChartOption(): void {
    this.chartOption = buildScatter3DChartOption(this.data, this.config);
  }
